...
$namaFile = $draft['draft_sekolah'] ?? null;
?>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <span><i class="fas fa-gavel me-1"></i> Draft Informasi Sekolah Inklusi</span>
                            <div>
                                <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') : ?>
                                    <a href="edit_informasi.php" class="btn btn-sm btn-warning me-2">
                                        <i class="fas fa-edit"></i> Ubah Draft
                                    </a>
                                <?php endif; ?>
                                <?php if ($namaFile) : ?>
