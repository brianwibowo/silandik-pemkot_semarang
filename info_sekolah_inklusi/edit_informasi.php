        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Ubah Draft Informasi Inklusi</h1>
                        ...
                        if ($uploadOk) {
                            ...
                            if (move_uploaded_file($_FILES["draft"]["tmp_name"], $targetFile)) {
                                ...
                                echo "<script>
                                    Swal.fire({
                                        title: 'Berhasil!',
                                        text: 'Draft informasi berhasil diperbarui.',
                                        icon: 'success',
                                        confirmButtonColor: '#198754',
                                        confirmButtonText: 'OK'
                                    }).then(() => {
                                        window.location.href = '/silandik-semarang/info_sekolah_inklusi/informasi_sekolah_inklusi.php';
                                    });
                                </script>";
                            } else {
                                echo "<script>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <a href="/silandik-semarang/info_sekolah_inklusi/informasi_sekolah_inklusi.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
