            ...
            <div class="cards-grid" id="schoolGrid">
                ...
                if (!$query) {
                    ...
                    while ($row = mysqli_fetch_assoc($query)) :
                        ...
                        $jenjang_class = match (strtoupper($row['jenjang_sekolah'])) {
                            'SD' => 'badge-success',
                            'SMP' => 'badge-warning',
                ...
                ?>
                        <div class="school-card"
                            ...
                            <div class="school-image-container">
                                ...
                                <?php endif; ?>
                                <div class="school-badge <?= strtolower($row['jenjang_sekolah']); ?>"><?= htmlspecialchars($row['jenjang_sekolah']); ?></div>
                            </div>
