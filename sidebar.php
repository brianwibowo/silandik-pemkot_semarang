...
<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse" id="collapseInformasi" aria-labelledby="headingInformasi" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="info_sekolah_inklusi/informasi_sekolah_inklusi.php">Informasi Sekolah Inklusi</a>
                    </nav>
                </div>
                </a>
                ...
                <div class="collapse" id="collapseDokumen" aria-labelledby="headingDokumen" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="dokumen_kurikulum/dokumen_kurikulum_inklusi.php">Dokumen Kurikulum Inklusi</a>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <?php else : ?>
            <!-- Tombol Login Admin -->
            <div class="text-center p-3">
                <a href="authentification/login.php" class="btn btn-success w-100">Login Admin &rarr;</a>
            </div>
        <?php endif; ?>
        <!-- Footer -->
